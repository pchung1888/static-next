...
function Index(props: any) {
  return (
    <>
      ...
      <p>
        This page is statically generated and does not update until redeployed.
        You'll notice that the "Page generated on:" date doesn't change until
        the website is redeployed. Use the "Regenerate site" link below to
        redeploy.
      </p>
      ...
      <ul>
        <li>
          <p>
            Slugs not explicitly handled by `getStaticPaths` for static
            generation can be statically generated upon first visit. Try it out
            by visiting some non-sense url like:
          </p>
          <Link href="/ssg/[slug]" as="/ssg/sadasdasdasdasdasdqweqwdeasdqweqw">
            <a>nonsensical SSG URL</a>
          </Link>
          <p>
            Subsequent visits to this weird URL will then serve up the
            statically generated version.
          </p>
          <small>
            P.s. because I use `next/link` component here automatic prefetching
            is enabled and it will trigger the initial static generation
            automagically.
          </small>
        </li>
      </ul>
      <p>
        This implementation uses <i>getStaticProps</i> and <i>getStaticPaths</i>
        .
      </p>
